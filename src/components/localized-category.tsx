...
const chrome = {
  en: { home: "Home", eyebrow: "TOPIC", core: "Guides", columns: "Columns", back: "Back to the home page", note: "Careful, source-based reading", noteBody: "Each article has a separate editorial manuscript in this language. Check the evidence, limitations, and medical questions before making a decision.", navLabel: "Browse by category", all: "All articles" },
  zh: { home: "首页", eyebrow: "主题", core: "指南", columns: "专栏", back: "返回首页", note: "基于来源的谨慎阅读", noteBody: "每篇文章都有单独的中文编辑原稿。做出决定前，请确认证据、局限性和需要向医生询问的问题。", navLabel: "按主题浏览", all: "全部文章" },
} as const;
