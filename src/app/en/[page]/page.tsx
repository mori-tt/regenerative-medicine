...
export async function generateMetadata({ params }: { params: Promise<{ page: string }> }) { const { page } = await params; if (!pages.includes(page as InfoSlug)) notFound(); return pageMetadata(infoTitleFor("en", page as InfoSlug), "Translated site information", `/en/${page}/`, false); }
