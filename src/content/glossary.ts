...
export const glossaryGroups: GlossaryGroup[] = [
  {
    ...
    terms: [
      ...
      {
        ja: ["胚", "受精後の発生初期段階。ES細胞の由来となる段階を含み、倫理面の配慮が求められます。"],
        en: ["Embryo", "The early stage of development after fertilization — the source stage of ES cells, requiring ethical care."],
        zh: ["胚胎", "受精后发育的初期阶段，是ES细胞的来源阶段，需要伦理上的慎重对待。"],
        link: "es-cells-explained",
        ref: { title: "CiRA（京都大学iPS細胞研究所）", url: "https://www.cira.kyoto-u.ac.jp/j/faq/faq_index.html" },
      },
      {
        ja: ["胚盤胞", "胚の発生の一つの段階。内部の細胞塊がES細胞の材料になります。"],
  ...
  },
  {
    ...
    terms: [
      ...
      {
        ja: ["再生医療", "傷ついた組織や臓器を、細胞などを使って修復・再生させることを目指す医療の総称。"],
        en: ["Regenerative medicine", "The umbrella term for medicine that aims to repair or regenerate damaged tissues using cells and related methods."],
        zh: ["再生医学", "利用细胞等修复、再生受损组织器官的医学总称。"],
        link: "what-is-regenerative-medicine",
        ref: { title: "日本再生医療学会", url: "https://jsrm.jp/" },
      },
      {
        ja: ["細胞治療", "細胞そのものを体内に入れて治療する方法。再生医療の一つの柱です。"],
        en: ["Cell therapy", "Treatment that delivers cells into the body — a core pillar of regenerative medicine."],
        zh: ["细胞治疗", "将细胞直接输入体内进行治疗的方法，是再生医学的支柱之一。"],
        link: "stem-cell-treatment-contents",
        ref: { title: "日本再生医療学会", url: "https://jsrm.jp/" },
      },
      {
        ja: ["特定細胞加工物", "細胞を加工して作られる製品・素材。再生医療等安全性確保法の届出対象です。"],
        en: ["Specified processed cell product", "Products made by processing cells — subject to filing under the safety act."],
        zh: ["特定细胞加工物", "通过加工细胞制备的产品或材料，是《再生医疗等安全性确保法》的申报对象。"],
        link: "cell-processing-license-system",
        ref: { title: "厚生労働省「再生医療等の安全性の確保等に関する法律」", url: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/kenkou_iryou/iryou/saisei_iryou/index.html" },
      },
      {
        ja: ["臨床研究法", "臨床研究の実施手続きや審査を定める法律。説明と同意の要件を含みます。"],
        en: ["Clinical Research Act", "The law governing procedures and review of clinical research, including explanation and consent requirements."],
        zh: ["临床研究法", "规定临床研究实施程序与审查的法律，包含说明与同意的要求。"],
        ref: { title: "臨床研究法（e-Gov法令検索）", url: "https://laws.e-gov.go.jp/law/429AC0000000016" },
        link: "clinical-trials-guide",
      },
      {
        ja: ["jRCT（臨床研究等提出・公開システム）", "日本の臨床研究の登録・公開システム。計画や結果を検索できます。"],
        en: ["jRCT", "Japan's registry for clinical research — plans and results are publicly searchable."],
        zh: ["jRCT（临床研究等申报公开系统）", "日本临床研究的登记与公开系统，可检索计划与结果。"],
        link: "how-to-find-trials",
        ref: { title: "jRCT（厚生労働省）", url: "https://jrct.mhlw.go.jp/" },
      },
      {
        ja: ["UMIN-CTR", "日本の臨床試験登録の一つの窓口。研究計画を検索できます。"],
        en: ["UMIN-CTR", "One of Japan's clinical-trial registries where study plans can be searched."],
        zh: ["UMIN-CTR", "日本临床试验注册的窗口之一，可检索研究计划。"],
        link: "how-to-find-trials",
        ref: { title: "UMIN-CTR", url: "https://www.umin.ac.jp/ctr/" },
      },
      {
        ja: ["高額療養費制度", "保険診療で自己負担が高額になった場合に上限を設ける制度。"],
        en: ["High-cost care cap", "The system capping out-of-pocket costs for insured care."],
        zh: ["高额疗养费制度", "医保诊疗中自负费用过高时设上限的制度。"],
        link: "high-cost-care",
        ref: { title: "厚生労働省 e-ヘルスネット", url: "https://www.e-healthnet.mhlw.go.jp/" },
      },
      {
        ja: ["医療費控除", "一定額を超えた医療費を確定申告で税額に反映する制度。"],
        en: ["Medical expense deduction", "A tax deduction claimed via a tax return for medical expenses above a threshold."],
        zh: ["医疗费扣除", "超过一定金额的医疗费可通过确定申告抵税的制度。"],
        link: "tax-deduction",
        ref: { title: "国税庁「医療費控除」", url: "https://www.nta.go.jp/" },
      },
      {
  ...
  },
  {
    ...
    terms: [
      ...
      {
        ja: ["予後", "病気や治療のその後の見通し。治療効果の説明で出てくる言葉です。"],
        en: ["Prognosis", "The expected course of a disease or after treatment."],
        zh: ["预后", "疾病或治疗后的预计经过，在疗效说明中会出现。"],
        link: "hospital-words",
        ref: { title: "厚生労働省 e-ヘルスネット", url: "https://www.e-healthnet.mhlw.go.jp/" },
      },
      {
        ja: ["アウトカム（アウトカム指標）", "治療効果を測るための結果指標。生存率・症状スコアなどがあります。"],
  ...
  },
  {
    ...
    terms: [
      ...
      {
        ja: ["染色体", "DNAがまとまった構造体。細胞の設計情報の保存単位です。"],
        en: ["Chromosome", "A bundled structure of DNA — the storage unit of genetic information."],
        zh: ["染色体", "DNA凝聚形成的结构，是遗传信息的保存单位。"],
        link: "dna-basics",
        ref: { title: "厚生労働省 e-ヘルスネット", url: "https://www.e-healthnet.mhlw.go.jp/" },
      },
      {
        ja: ["ゲノム", "その細胞が持つ遺伝情報の全体。"],
      ...
      },
      {
        ...
        en: ["Sepsis", "A serious whole-body response to infection that can become life-threatening — early action matters."],
        zh: ["败血症", "对感染产生的强烈全身反应，可能危及生命，早期应对很重要。"],
        link: "emergency-care",
        ref: { title: "厚生労働省 e-ヘルスネット", url: "https://www.e-healthnet.mhlw.go.jp/" },
      }
    ],
