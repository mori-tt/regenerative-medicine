...
export const localizedShell = {
  en: {
    logoName: "Regenerative Medicine Guide", logoAria: "Regenerative Medicine Guide home", tagline: "Clearer information for your next medical decision.", preview: "Sources checked and explained in plain language", promise: "One careful step at a time.", editorial: "Editorial policy", supervision: "Medical review", search: "Find articles", searchAria: "Find articles", home: "Home", about: "About this site", basics: "The basics", stemCells: "Stem cells", treatment: "Considering treatment", research: "Research & news", menu: "Open menu", guide: "Getting started", articles: "All articles", glossary: "Glossary", faq: "FAQ", safety: "Safety", regulation: "Rules & systems", advertising: "Advertising", terms: "Terms of use", privacy: "Privacy policy", disclaimer: "Important notice", contact: "Contact", updates: "Updates", corrections: "Corrections & updates", citations: "Citations & reuse", sources: "Sources and references", accessibility: "Accessibility", siteGuide: "Site guide", footerLead: "Understanding comes before choice.\nA careful guide connecting regenerative medicine with people.", footerDisclaimer: "This site provides general information and is not a substitute for diagnosis or treatment. Please consult a qualified healthcare professional.", copyright: "KNOWLEDGE FOR YOUR NEXT STEP.",
  },
  zh: {
    logoName: "再生医学指南", logoAria: "再生医学指南首页", tagline: "为下一步医疗决定提供清晰的信息。", preview: "核对来源，以清晰易懂的方式整理信息", promise: "一步一步，谨慎理解。", editorial: "编辑方针", supervision: "医学审核", search: "查找文章", searchAria: "查找文章", home: "首页", about: "关于本网站", basics: "再生医学基础", stemCells: "认识干细胞", treatment: "考虑治疗时", research: "研究与新闻", menu: "打开菜单", guide: "入门指南", articles: "全部文章", glossary: "术语表", faq: "常见问题", safety: "安全性", regulation: "制度与法规", advertising: "广告刊登", terms: "使用条款", privacy: "隐私政策", disclaimer: "重要说明", contact: "联系我们", updates: "更新信息", corrections: "勘误与更新", citations: "引用与转载", sources: "信息来源与参考网站", accessibility: "无障碍", siteGuide: "网站地图", footerLead: "充分了解，是做出选择的第一步。\n连接再生医学与每个人的谨慎指南。", footerDisclaimer: "本网站提供一般性信息，不能替代诊断或治疗。涉及个人医疗决定时，请咨询有资质的医疗专业人员。", copyright: "KNOWLEDGE FOR YOUR NEXT STEP.",
  },
} as const;
